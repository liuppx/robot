...
class Settings(BaseSettings):
    ...
    public_base_url: str | None = Field(default=None, alias="HUB_PUBLIC_BASE_URL")
    ...
    session_cookie_secure_mode: str = Field(default="auto", alias="HUB_SESSION_COOKIE_SECURE_MODE")
